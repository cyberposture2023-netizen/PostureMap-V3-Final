...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Azure\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Azure\evidence.json'
...
Write-Host ' Connected: Azure (Cloud Security)  Demo evidence seeded.'
