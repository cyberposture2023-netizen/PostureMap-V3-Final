...
$statusPath = 'D:\PostureMap-V3-Final\integrations\DatadogLogs\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\DatadogLogs\evidence.json'
...
Write-Host ' Connected: DatadogLogs (Log Management)  Demo evidence seeded.'
