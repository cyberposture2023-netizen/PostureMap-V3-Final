...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Splunk\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Splunk\evidence.json'
...
Write-Host ' Connected: Splunk (Log Management)  Demo evidence seeded.'
