...
$statusPath = 'D:\PostureMap-V3-Final\integrations\PrismaCloud\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\PrismaCloud\evidence.json'
...
Write-Host ' Connected: PrismaCloud (Cloud Security)  Demo evidence seeded.'
