...
$statusPath = 'D:\PostureMap-V3-Final\integrations\AzureAD\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\AzureAD\evidence.json'
...
Write-Host ' Connected: AzureAD (Identity & Access)  Demo evidence seeded.'
