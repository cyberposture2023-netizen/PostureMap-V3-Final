...
$statusPath = 'D:\PostureMap-V3-Final\integrations\SonarQube\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\SonarQube\evidence.json'
...
Write-Host ' Connected: SonarQube (Code & App Security)  Demo evidence seeded.'
