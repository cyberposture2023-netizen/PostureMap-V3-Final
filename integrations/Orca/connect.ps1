...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Orca\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Orca\evidence.json'
...
Write-Host ' Connected: Orca (Vulnerability Management)  Demo evidence seeded.'
