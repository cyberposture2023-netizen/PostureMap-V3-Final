...
$statusPath = 'D:\PostureMap-V3-Final\integrations\JumpCloud\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\JumpCloud\evidence.json'
...
Write-Host ' Connected: JumpCloud (Identity & Access)  Demo evidence seeded.'
