...
$statusPath = 'D:\PostureMap-V3-Final\integrations\GCP\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\GCP\evidence.json'
...
Write-Host ' Connected: GCP (Cloud Security)  Demo evidence seeded.'
