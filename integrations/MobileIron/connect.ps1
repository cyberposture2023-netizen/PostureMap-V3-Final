...
$statusPath = 'D:\PostureMap-V3-Final\integrations\MobileIron\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\MobileIron\evidence.json'
...
Write-Host ' Connected: MobileIron (Device Management)  Demo evidence seeded.'
