...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Tenable\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Tenable\evidence.json'
...
Write-Host ' Connected: Tenable (Vulnerability Management)  Demo evidence seeded.'
