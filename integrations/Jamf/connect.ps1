...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Jamf\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Jamf\evidence.json'
...
Write-Host ' Connected: Jamf (Device Management)  Demo evidence seeded.'
