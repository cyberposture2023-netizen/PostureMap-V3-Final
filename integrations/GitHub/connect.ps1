...
$statusPath = 'D:\PostureMap-V3-Final\integrations\GitHub\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\GitHub\evidence.json'
...
Write-Host ' Connected: GitHub (Code & App Security)  Demo evidence seeded.'
