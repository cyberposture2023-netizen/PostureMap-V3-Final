...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Kandji\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Kandji\evidence.json'
...
Write-Host ' Connected: Kandji (Device Management)  Demo evidence seeded.'
