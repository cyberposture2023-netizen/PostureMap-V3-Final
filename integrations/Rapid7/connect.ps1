...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Rapid7\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Rapid7\evidence.json'
...
Write-Host ' Connected: Rapid7 (Vulnerability Management)  Demo evidence seeded.'
