...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Snyk\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Snyk\evidence.json'
...
Write-Host ' Connected: Snyk (Code & App Security)  Demo evidence seeded.'
