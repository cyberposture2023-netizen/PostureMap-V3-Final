...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Veracode\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Veracode\evidence.json'
...
Write-Host ' Connected: Veracode (Code & App Security)  Demo evidence seeded.'
