...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Intune\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Intune\evidence.json'
...
Write-Host ' Connected: Intune (Device Management)  Demo evidence seeded.'
