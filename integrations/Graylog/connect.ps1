...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Graylog\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Graylog\evidence.json'
...
Write-Host ' Connected: Graylog (Log Management)  Demo evidence seeded.'
