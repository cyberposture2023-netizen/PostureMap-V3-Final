...
$statusPath = 'D:\PostureMap-V3-Final\integrations\Qualys\status.json'
$evidencePath = 'D:\PostureMap-V3-Final\integrations\Qualys\evidence.json'
...
Write-Host ' Connected: Qualys (Vulnerability Management)  Demo evidence seeded.'
